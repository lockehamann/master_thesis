...
\subsubsection{动态TWIGL二维基准问题（阶跃反应性）}

动态TWIGL二维基准题阶跃反应性计算结果见
\floatref{fig:testresult.twigl.1.1}、
\floatref{fig:testresult.twigl.1.2}、
\floatref{fig:testresult.twigl.1.4}、
\floatref{fig:testresult.twigl.1.8}，
并使用1cm网格时间步长0.01s的结果作为参考解计算其他参数下的总功率偏差。

\begin{figure}[H]
\centering
%\subcaptionbox{计算时间图\label{fig:testresult.twigl.1.1.time}}
{
\includegraphics[scale=0.8]{result-twigl1-s1-time}
}
%\subcaptionbox{误差图\label{fig:testresult.twigl.1.1.err}}
{
\includegraphics[scale=0.8]{result-twigl1-s1-err}
}
\caption{动态TWIGL二维基准题阶跃反应性(网格1cm)\label{fig:testresult.twigl.1.1}}
\end{figure}

\begin{figure}[H]
\centering
%\subcaptionbox{计算时间图\label{fig:testresult.twigl.1.2.time}}
{
\includegraphics[scale=0.8]{result-twigl1-s2-time}
}
%\subcaptionbox{误差图\label{fig:testresult.twigl.1.2.err}}
{
\includegraphics[scale=0.8]{result-twigl1-s2-err}
}
\caption{动态TWIGL二维基准题阶跃反应性(网格2cm)\label{fig:testresult.twigl.1.2}}
\end{figure}

\begin{figure}[H]
\centering
%\subcaptionbox{计算时间图\label{fig:testresult.twigl.1.4.time}}
{
\includegraphics[scale=0.8]{result-twigl1-s4-time}
}
%\subcaptionbox{误差图\label{fig:testresult.twigl.1.4.err}}
{
\includegraphics[scale=0.8]{result-twigl1-s4-err}
}
\caption{动态TWIGL二维基准题阶跃反应性(网格4cm)\label{fig:testresult.twigl.1.4}}
\end{figure}

\begin{figure}[H]
\centering
%\subcaptionbox{计算时间图\label{fig:testresult.twigl.1.8.time}}
{
\includegraphics[scale=0.8]{result-twigl1-s8-time}
}
%\subcaptionbox{误差图\label{fig:testresult.twigl.1.8.err}}
{
\includegraphics[scale=0.8]{result-twigl1-s8-err}
}
\caption{动态TWIGL二维基准题阶跃反应性(网格8cm)\label{fig:testresult.twigl.1.8}}
\end{figure}
...
\subsubsection{动态TWIGL二维基准问题（线性反应性）}

线性反应性计算结果见
\floatref{fig:testresult.twigl.2.1}、
\floatref{fig:testresult.twigl.2.2}、
\floatref{fig:testresult.twigl.2.4}和
...
\caption{动态TWIGL二维基准题线性反应性(网格1cm)\label{fig:testresult.twigl.2.1}}
\end{figure}
...
\caption{动态TWIGL二维基准题线性反应性(网格2cm)\label{fig:testresult.twigl.2.2}}
\end{figure}
...
\caption{动态TWIGL二维基准题线性反应性(网格4cm)\label{fig:testresult.twigl.2.4}}
\end{figure}
...
\caption{动态TWIGL二维基准题线性反应性(网格8cm)\label{fig:testresult.twigl.2.8}}
\end{figure}
