...
\floatref{tab:testresult.twigl.1}、
...
线性反应性计算结果见
\floatref{tab:testresult.twigl.2}、
...
动态LMW三维基准题计算结果见
\floatref{fig:testresult.lwm.1}至
...
以上结果中下面条件可以实现实时模拟：
\begin{enumerate}[a)]
\item xy方向1.25cm网格，z方向1cm（$88\times88\times200=1548800$个），时间步长5s、10s。
\item xy方向2cm网格，z方向1cm（$55\times55\times200=605000$个），时间步长2s-10s。
\item xy方向2.5cm网格，z方向1cm（$44\times44\times200=387200$个），时间步长1s-10s。
\item xy方向5cm网格，z方向1cm（$22\times22\times200=96800$个），时间步长1/2s-10s。
\item xy方向10cm网格，z方向1cm（$11\times11\times200=24200$个），时间步长1/3s-10s。
\end{enumerate}
